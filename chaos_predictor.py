def chaos_predictor_tab(df, season_avg):
    ...
    if predict_button:
        ...
        def get_model(features, target):
            return train_chaos_model(features, target)

        model = get_model(features, target)
        ...
        display_prediction_card(predicted_chaos, df, season_avg)

        # Show similar games
        display_similar_games(predicted_chaos, df)


def display_prediction_card(predicted_chaos, df, season_avg):
...
def display_similar_games(predicted_chaos, df):
